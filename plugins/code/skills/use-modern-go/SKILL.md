---
name: use-modern-go
description: Apply modern Go syntax guidelines based on the project's Go version. Use when writing, reviewing, designing, or fixing Go code, or when the user asks for modern Go code guidelines.
---
...
- Target modern Go best practices and freely use language features up to and including this version.
- Do NOT list features, do NOT ask for confirmation.

**If version is "unknown":**
- Default to targeting the latest stable Go version listed below when running non-interactively (e.g. inside an agent). If interacting directly with the user, ask which Go version to target.
